...
def compute_parse_tree_metrics(sent) -> dict:
    ...
    parse_tree = {  'right_branches_all': count_right/len(sent),
                    'left_branches_all': count_left/len(sent),
                    'right_branches_NP': count_right_NP / len(sent),
                    'left_branches_NP': count_left_NP / len(sent),
